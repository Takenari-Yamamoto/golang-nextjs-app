...
var TaskWhere = struct {
	...
	Completed:   whereHelperbool{field: "\"tasks\".\"completed\""},
...
var (
	taskAllColumns            = []string{"id", "title", "description", "completed", "created_at", "updated_at"}
	taskColumnsWithoutDefault = []string{"title"}
	taskColumnsWithDefault    = []string{"id", "description", "completed", "created_at", "updated_at"}
