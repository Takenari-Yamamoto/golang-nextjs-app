...
var (
	taskDBTypes = map[string]string{`ID`: `character varying`, `Title`: `character varying`, `Content`: `text`, `Done`: `boolean`, `Createdby`: `character varying`, `Createdat`: `timestamp without time zone`}
	_           = bytes.MinRead
)
