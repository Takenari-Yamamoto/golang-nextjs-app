...
var TaskWhere = struct {
	...
	Content:   whereHelperstring{field: "\"tasks\".\"content\""},
	Done:      whereHelperbool{field: "\"tasks\".\"done\""},
	Createdby: whereHelperstring{field: "\"tasks\".\"createdby\""},
	Createdat: whereHelpertime_Time{field: "\"tasks\".\"createdat\""},
}
...
var (
	taskAllColumns            = []string{"id", "title", "content", "done", "createdby", "createdat"}
	taskColumnsWithoutDefault = []string{"id", "title", "content", "done", "createdby", "createdat"}
